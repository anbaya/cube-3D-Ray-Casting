...
LFLAGS = -L./includes/minilibx -lmlx -lXext -lX11 -lm -lz
...
SRC = src/cube.c src/ghraphics/player.c src/ghraphics/movements.c src/ghraphics/key_hooks.c src/ghraphics/positions.c \
		...
		src/parsing/tools_2.c src/parsing/tools_3.c src/parsing/tools_4.c src/parsing/tools_5.c src/memory/memoryCleaner.c
